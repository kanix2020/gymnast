  ...
  def send_scores_csv(scores)
    csv_data = CSV.generate(row_sep: "\r\n", encoding:Encoding::CP932)  do |csv|
      ...
      scores.each do |score|
        ...
        values_total = ["","-",(score.floor_d + score.floor_e - score.floor_nd),(score.pommel_d + score.pommel_e - score.pommel_nd),(score.rings_d + score.rings_e - score.rings_nd),(score.vault_d + score.vault_e - score.vault_nd),(score.parallel_d + score.parallel_e - score.parallel_nd),(score.horizontal_d + score.horizontal_e - score.horizontal_nd),
        (score.floor_d + score.floor_e - score.floor_nd) + (score.pommel_d + score.pommel_e - score.pommel_nd) + (score.rings_d + score.rings_e - score.rings_nd) + (score.vault_d + score.vault_e - score.vault_nd) + (score.parallel_d + score.parallel_e - score.parallel_nd) + (score.horizontal_d + score.horizontal_e - score.horizontal_nd)]
